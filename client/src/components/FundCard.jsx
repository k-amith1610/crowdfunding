    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <h3
                        className="font-epilogue font-semibold text-[16px] text-white text-left 
                        leading-[26px] truncate"
                    >
                        {title}
                    </h3>
                    <p
                        className="mt-[5px] font-epilogue font-semibold text-[12px] text-[#808191]
                ...
                >
                    <div
                        className="w-[30px] h-[30px] rounded-full flex justify-center
